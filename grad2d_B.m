...
%
% Examples
%Theta=grad2d_B; % use all default parameters for Case B
%Theta=grad2d_B(250,0.4,1E6,0.5,2.2,-3,1.5,-2); % full call with plot
%Theta=grad2d_B(250,0.4,1E6,0.5,2.2,-3,1.5,-2,1); % no plot enabled
...
elseif nargin==9
    ...
    error('Usage: Theta=grad2d_B(K,step,NS,c,a,b,g,h,no_plot)')
end

svec=[1;-1]; % gradient ascent/descent

theta=[b h]'; % optimise over b &
